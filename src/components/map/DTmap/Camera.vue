                ...
                success:function(data){
                    if(data.errorCode=='0'){
                        ...
                        if(that.locationType=='1'){
                            ...
                            //添加灯杆坐标放
                            var online = new BMap.Icon(that.imgserverurl+"image/img/Camera02.png", new BMap.Size(45,60));
                            var offline = new BMap.Icon(that.imgserverurl+"image/img/Camera03.png", new BMap.Size(45,60));
                            var Unknown = new BMap.Icon(that.imgserverurl+"image/img/Camera04.png", new BMap.Size(45,60));
                            var abnormal = new BMap.Icon(that.imgserverurl+"image/img/Camera01.gif", new BMap.Size(45,60));
                            var markers = []
                            for(var i=0;i<data.result.cameras.length;i++){
