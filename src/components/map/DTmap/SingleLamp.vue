                ...
                success:function(data){
                    if(data.errorCode=='0'){
                        ...
                        if(that.locationType=='1'){
                            ...
                            //添加灯杆坐标
                            var online = new BMap.Icon(that.imgserverurl+"image/img/SingleLamp02.png", new BMap.Size(45,60));
                            var offline = new BMap.Icon(that.imgserverurl+"image/img/SingleLamp03.png", new BMap.Size(45,60));
                            var Unknown = new BMap.Icon(that.imgserverurl+"image/img/SingleLamp04.png", new BMap.Size(45,60));
                            var abnormal = new BMap.Icon(that.imgserverurl+"image/img/SingleLamp01.gif", new BMap.Size(45,60));
                            var markers = []
                            for(var i=0;i<data.result.list.length;i++){
