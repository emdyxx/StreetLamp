                ...
                success:function(data){
                    if(data.errorCode=='0'){
                        ...
                        if(that.locationType=='1'){
                            ...
                            //添加灯杆坐标
                            var online = new BMap.Icon(that.imgserverurl+"image/img/Scenery02.png", new BMap.Size(45,60));
                            var offline = new BMap.Icon(that.imgserverurl+"image/img/Scenery03.png", new BMap.Size(45,60));
                            var Unknown = new BMap.Icon(that.imgserverurl+"image/img/Scenery04.png", new BMap.Size(45,60));
                            var abnormal = new BMap.Icon(that.imgserverurl+"image/img/Scenery01.png", new BMap.Size(45,60));
                            var markers = []
                            for(var i=0;i<data.result.list.length;i++){
