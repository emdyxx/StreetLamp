...
.todayPatrolPlan_top{height: 40px;display: flex;justify-content: center;align-items: center;}
.todayPatrolPlan_top>div{display:flex;align-items: center;}
.todayPatrolPlan_top>div>span{line-height: 46px;width: 60px;text-align: right}
.todayPatrolPlan_top>div>input{width: 126px;}
.todayPatrolPlan_bottom{position: absolute;top: 40px;bottom: 0;width: 100%;}
</style>
<style>
